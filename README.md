...
No Warranty: This software is provided "as is," without warranty of any kind. The weighted penalty model is a heuristic approach; while it provides high-accuracy signals, no fingerprinting method is 100% infallible.

Compliance: Users are responsible for ensuring their use of PayOffFP complies with local data protection regulations (e.g., GDPR, CCPA).
